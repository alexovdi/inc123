...
export const contactData: ContactData = {
  ...
  formFields: [
    { name: "firstName", label: "First Name", type: "text", required: true, placeholder: "Your first name", halfWidth: true },
    { name: "lastName", label: "Last Name", type: "text", required: true, placeholder: "Your last name", halfWidth: true },
    { name: "email", label: "Email Address", type: "email", required: true, placeholder: "you@example.com", halfWidth: true },
    { name: "phone", label: "Phone Number", type: "tel", placeholder: "(555) 123-4567", halfWidth: true },
    {
      name: "inquiryType",
      ...
      options: [
        ...
        "Existing Entity — Compliance",
        "Existing Entity — Domestication",
        "Packages & Pricing",
        "Other",
      ],
      halfWidth: true,
    ...
    { name: "message", label: "Your Message", type: "textarea", required: true, placeholder: "Tell us about your needs..." },
    {
      name: "referralSource",
      label: "How did you hear about us?",
      type: "select",
      options: ["Referral from Accountant/Attorney", "Referral from a Client", "Google Search", "Blog / Article", "Social Media", "Returning Client", "Other"],
    },
  ],
  quickLinks: [
    {
      ...
      description: "See all formation packages side by side with transparent pricing.",
      href: "/compare-packages",
    },
    {
      icon: "CircleQuestionMark",
      title: "FAQ",
      description: "Answers to common questions about privacy, formation, and compliance.",
      href: "/faq",
    },
    {
      icon: "Shield",
