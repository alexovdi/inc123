# Incorporate123 — Navigation Specification (Layout & Content Only)
...
### Why "Get Started" Is Not Primary Style

The header CTA uses secondary styling to avoid visual competition with in-page primary conversion CTAs. If the header button were primary style, every page would have two primary CTAs above the fold (header + page primary), violating the one-primary-per-section rule.

### Sticky Scroll Behavior

| State                     | Height                  | Elements                                    |
| ------------------------- | ----------------------- | ------------------------------------------- |
| **Default** (top of page) | 80px                    | All elements visible                        |
| **Scrolled** (past hero)  | 60px                    | All elements visible, logo reduced slightly |
| **Mega menu open**        | 80px (locks to default) | Overlay dims page content behind menu       |
...
```
┌──────────────────────────────────────────────────────────────────────────────┐
│  PRIVACY                      │  ASSET PROTECTION          │  FORMATION                     │
│  ─────────────────────        │  ─────────────────────     │  ─────────────────────        │
...
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| **Column header**        | Pillar name. Clickable — links to pillar hub.                                                                            |
| **Top border accent**    | 3px solid in pillar identity. Establishes the pillar system.                                                             |
| **Cluster links**        | All cluster pages listed alphabetically within the pillar.                                                               |
| **"Compare" subsection** | Separated by a subtle divider and "Compare" label. Lists comparison pages for that pillar.                               |
| **Footer link**          | "Explore All [Pillar] →" — links to pillar hub page.                                                                     |
...
| **Links**     | "Home" links to `/`. Pillar name links to pillar hub. Current page is not linked (plain text).                          |
...
| **CTA button** | Primary, compact size. Fills available width minus phone icon space.                            |
...
| **Crypto icons**       | Small badge-style. BTC, ETH, XRP, LTC, XMR. Subtle.                                                                                            |
...
| Header scroll compact | 150ms transition on height                                  | Smooth but quick — shouldn't feel sluggish                       |
