...
export default async function ComplianceClusterPage({ params }: PageProps) {
  const { slug } = await params;
  const page = getContentByFilename(FOLDER, slug);
  if (!page) notFound();
  ...
  return (
    <>
      ...
      <CTABand
        ...
        description="Annual reports, registered agent services, and ongoing compliance support."
