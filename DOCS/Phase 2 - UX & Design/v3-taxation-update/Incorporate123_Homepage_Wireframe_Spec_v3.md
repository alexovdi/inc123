...
| 10 | "Real Reno Office" replaced with "Specialist Team" throughout | 3.2, 6.2, 8 | David feedback: de-emphasize physical office; emphasize team expertise instead |
| 11 | Removed BOI Reporting from Privacy mega menu | 2.3 | David feedback: BOI removed from Privacy cluster listings |
| 12 | Hero visual updated to abstract imagery (removed Reno office photography) | 3.1 | David feedback: no office photography references |
| 13 | Domain confirmed as incorporate123.co | 15, 17 | Domain decision resolved |
| 14 | Added 2nd-Tier State Filings and Shares & Corporate Records to Compliance listings | 12.1 | New Compliance clusters added |
| 15 | Removed office photography and bio photo from content dependencies | 17 | No longer needed |

### Changelog (v3)

| # | Change | Section | Rationale |
|---|--------|---------|-----------|
| 16 | Added Entity Tax Guide to Formation mega menu clusters and footer | 2.3, 12.1 | New taxation content: pre-formation decision-support page under Formation pillar |
| 17 | Added Tax Filing & Obligations to Compliance mega menu clusters and footer | 12.1 | New taxation content: post-formation compliance page under Compliance pillar |
...
| Column | Links |
|--------|-------|
| Clusters | Anonymous LLC Formation · Nominee Services · Wyoming Private Incorporation · Nevada Private Incorporation · California Private LLC · Florida Private LLC · Offshore Privacy |
...
| Column | Links |
|--------|-------|
| Clusters | Wyoming LLC · Nevada LLC · Wyoming Corporation · Nevada Corporation · LLC vs Corporation · Shelf Companies · Entity Tax Guide |
...
**Desktop:** Full-width section with a split layout — left side contains headline, subheadline, and dual CTA; right side contains a supporting visual (abstract privacy/shield imagery or professional brand visual).
...
| Trust Strip | "25 Years · Specialist Team · $1,275 All-Inclusive · Money-Back Guarantee" | Horizontal badge row below CTAs. "$1,275 All-Inclusive" (instead of generic "All-Inclusive Pricing") sets price expectations early and signals premium positioning — budget shoppers self-select out. |
...
| 4 | Users | "Specialist Team" | "Dedicated privacy specialists with 25 years of focused expertise. Not a generic filing service." |
...
| Tax Filing & Obligations | `/tax-obligations/` |
...
| Element | Content |
|---------|---------|
| Copyright | "(c) 2026 Incorporate123. All rights reserved." |
| Legal Links | Privacy Policy · Terms of Service |
| Phone | "(775) xxx-xxxx" |
| Address | Reno, Nevada mailing address (registered agent address) |
...
|------|--------|-------|--------|
| Domain confirmed: incorporate123.co | Confirmed | David | Canonical URL, all internal links |
