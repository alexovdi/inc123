    ...
    <div className="space-y-8">
      ...
      <SpecPanel
        ...
        items={[
          ...
          { label: "Package card", value: "bg-secondary/5 border-secondary/20 p-4", color: "bg-secondary" },
          { label: "Links", value: "text-body-sm text-link hover:text-link/80" },
  ...
  return (
    <div className="space-y-8">
      ...
      <SpecPanel
        ...
        items={[
          { label: "Callout-box", value: "bg-pillar-{toPillar}-soft border-pillar-{toPillar}/20" },
  ...
  return (
    <div className="space-y-8">
      ...
      <SpecPanel
        ...
        items={[
          { label: "Card", value: "border-border bg-surface rounded-card hover:shadow-card" },
          { label: "Pillar accent", value: "border-t-4 border-t-pillar-{pillar}" },
          { label: "Grid", value: "grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" },
        ]}
      />
    </div>
  );
  ...
  return (
    <div className="space-y-8">
      ...
      <SpecPanel
        ...
        items={[
          { label: "Card", value: "border-border bg-surface rounded-card p-6 hover:shadow-card" },
          { label: "Icon", value: "ArrowLeftRight text-secondary", color: "bg-secondary" },
        ]}
      />
    </div>
  );
    ...
    <div className="space-y-8">
      ...
      <SpecPanel
        ...
        items={[
          ...
          { label: "Consultation", value: "text-center text-body-sm text-muted mt-4" },
        ]}
      />
    </div>
  );
  ...
  return (
    <div className="space-y-8">
      ...
      <SpecPanel
        ...
        items={[
          { label: "Privacy accent", value: "border-t-pillar-privacy → #2563eb", color: "bg-pillar-privacy" },
          { label: "Asset accent", value: "border-t-pillar-asset → #16a34a", color: "bg-pillar-asset" },
          { label: "Formation accent", value: "border-t-pillar-formation → #d97706", color: "bg-pillar-formation" },
          { label: "Compliance accent", value: "border-t-pillar-compliance → #9333ea", color: "bg-pillar-compliance" },
          { label: "Hover", value: "shadow-card-hover -translate-y-1 transition-all" },
  ...
  return (
    <div className="space-y-8">
      ...
      <SpecPanel
        ...
        items={[
          { label: "Card", value: "border-border bg-surface rounded-card p-6 hover:border-secondary" },
          { label: "Active/selected", value: "border-secondary bg-secondary/5", color: "bg-secondary" },
          { label: "State label", value: "font-display text-heading-sm font-semibold" },
        ]}
      />
    </div>
  );
  ...
  return (
    <div className="space-y-8">
      ...
      <SpecPanel
        ...
        items={[
          { label: "Card", value: "border-border bg-surface rounded-card hover:shadow-card" },
          { label: "Pillar accent", value: "border-t-2 border-t-pillar-{pillar}" },
