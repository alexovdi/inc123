...
export const aboutData: AboutData = {
  ...
  timeline: [
    ...
    {
      year: "~2005",
      title: "Nominee Services Introduced",
      description:
        "Year-round nominees launched — a step beyond competitors' 'nominee for a day' model.",
    },
    {
      year: "~2008",
      title: "Offshore Structures Added",
      description:
        "Nevis, BVI, Panama, Hong Kong formation expanded international capability.",
    },
    {
      year: "~2012",
    ...
    {
      year: "~2020",
      title: "20 Years — Continued Growth",
      description:
        "Two decades of continuous operation. Deepening focus on privacy and asset protection.",
    },
    {
      year: "2026",
      title: "Privacy-First Redesign",
      description:
        "Most comprehensive update in company history. New architecture around privacy, protection, and formation.",
    },
  ],
  philosophy: [
    {
