  ...
  return (
    <div className="space-y-8">
        ...
        <StateGrid
          ...
          states={[
              ...
              children: (
                <div className="w-72">
                  <Accordion type="multiple" variant="default">
                    <AccordionItem id="s-1" title="What does 'anonymous LLC' mean?">
            ...
            },
            {
              ...
              children: (
                <div className="w-72">
                  <Accordion type="multiple" variant="default" defaultOpen={["s-2"]}>
                    <AccordionItem id="s-2" title="What does 'anonymous LLC' mean?">
                      <p className="text-body text-muted">An anonymous LLC is formed in a state that does not require public disclosure of the LLC&apos;s members or managers.</p>
                    </AccordionItem>
                  </Accordion>
                </div>
              ),
            },
            {
              ...
              children: (
                <div className="w-72">
                  <Accordion type="multiple" variant="default">
                    <AccordionItem id="s-3" title="Nominee director/officer?" badge="Privacy">
                      <p className="text-body text-muted">Content here.</p>
                    </AccordionItem>
                  </Accordion>
                </div>
      ...
      <SpecPanel
        ...
        items={[
          { label: "Trigger", value: "flex justify-between py-4 font-medium hover:text-secondary" },
          { label: "Border", value: "border-b border-border" },
          { label: "Chevron", value: "rotate-180 on expand, transition-transform" },
    ...
    <div className="space-y-8">
      ...
      <SpecPanel
        ...
        items={[
          ...
          { label: "Auto-play", value: "configurable interval, pauses on hover" },
        ]}
      />
    </div>
  );
  ...
  return (
    <div className="space-y-8">
      ...
      <SpecPanel
        ...
        items={[
          { label: "Step number", value: "bg-secondary text-white rounded-full w-10 h-10", color: "bg-secondary" },
  ...
  return (
    <div className="space-y-8">
      ...
      <SpecPanel
        ...
        items={[
          { label: "Inc123 column", value: "bg-success/10 text-success", color: "bg-success" },
          { label: "Competitor column", value: "bg-destructive/10 text-destructive", color: "bg-destructive" },
  ...
  return (
    <div className="space-y-8">
      ...
      <SpecPanel
        ...
        items={[
          { label: "Active step", value: "bg-secondary text-white", color: "bg-secondary" },
          { label: "Completed step", value: "bg-success text-white", color: "bg-success" },
          { label: "Upcoming step", value: "bg-muted/20 text-muted" },
          { label: "Connector", value: "h-0.5 bg-border (completed: bg-success)" },
