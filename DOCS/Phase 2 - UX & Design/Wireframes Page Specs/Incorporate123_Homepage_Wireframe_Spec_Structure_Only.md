...
| Primary CTA   | "Protect Your Privacy →"                                                                                                                                            | Routes to `/privacy/` pillar                                    |
| Secondary CTA | "View Packages & Pricing →"                                                                                                                                         | Routes to `/compare-packages/`                                  |
...
Layout: Horizontal row or 2×2 grid (desktop); horizontal scroll or stacked (mobile). Show the 4 primary packages with pricing visible.
...
Below cards: "Compare All Packages →" link routing to `/compare-packages/`.
...
| Bitcoin/Crypto | "Crypto Payments Accepted"      |
