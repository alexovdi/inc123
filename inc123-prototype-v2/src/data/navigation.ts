import type { SiteNavigation, FooterNavigation } from "@/lib/types";
      ...
      children: [
        {
          ...
          clusters: [
            ...
            },
            {
              ...
              href: "/privacy/wyoming-privacy",
              description: "Strongest domestic privacy structure",
            },
            {
              title: "Nevada Privacy",
              href: "/privacy/nevada-privacy",
              description: "Privacy through Nevada's nominee statutes",
            },
          ],
          featuredLink: {
      ...
      children: [
        {
          ...
          clusters: [
            ...
            },
            {
              ...
              href: "/asset-protection/wyoming-asset-protection",
              description: "The strongest state for asset protection",
            },
            {
              title: "Investment Holding LLC",
              href: "/asset-protection/investment-holding-llc",
              description: "Separate investment assets from operations",
            },
            {
              title: "Real Estate Asset Protection",
              href: "/asset-protection/real-estate-asset-protection",
              description: "Protect rental properties and investments",
            },
          ],
          featuredLink: {
      ...
      children: [
        {
          ...
          clusters: [
            ...
            },
            {
              ...
              href: "/formation/entity-tax-guide",
      ...
      children: [
        {
          ...
          clusters: [
            ...
            },
            {
              ...
              href: "/compliance/foreign-registration",
              description: "Register your entity in another state",
            },
            {
              title: "Tax Obligations",
              href: "/compliance/tax-obligations",
  ...
  pillars: [
    {
      ...
      links: [
        ...
        { label: "Wyoming Privacy", href: "/privacy/wyoming-privacy" },
        { label: "Nevada Privacy", href: "/privacy/nevada-privacy" },
      ],
    },
    {
