...
const PILLAR_COLOR = "#8a6d3d";

export async function generateMetadata(): Promise<Metadata> {
  const hub = getHubContent(PILLAR);
  if (!hub) return { title: "Company Formation" };
  return {
  ...
  return (
    <>
        ...
        <FadeUp>
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="font-[var(--font-display)] text-[var(--font-size-h2)] leading-tight text-[var(--color-text-on-dark)]">
              Why Inc123 for Formation?
            </h2>
            <p className="mt-6 text-lg leading-relaxed text-[var(--color-text-on-dark)] opacity-80">
              We&apos;ve formed thousands of entities across Wyoming, Nevada,
              and beyond since 1999. Every package is all-inclusive &mdash; no
              hidden fees, no upsells. You get filed articles, EIN, operating
              agreement, and a complete corporate record book, handled by real
              people in our Reno office.
            </p>
            <p className="mt-4 text-lg leading-relaxed text-[var(--color-text-on-dark)] opacity-80">
              Most formations complete in 3&ndash;7 business days, with same-day
              rush available.
            </p>
          </div>
        </FadeUp>
          ...
          {[
            {
              ...
              desc: "Starting your first business? We walk you through entity selection, state choice, and compliance requirements from day one.",
            },
            {
              title: "E-Commerce Sellers",
              desc: "Amazon, Shopify, and online sellers who need an LLC for liability protection, tax flexibility, and professional credibility.",
            },
            {
              title: "Freelancers & Contractors",
              desc: "Separate personal and business liability with a properly structured LLC — essential for client contracts and 1099 work.",
            },
            {
              title: "Investors & Holding Companies",
              desc: "Create holding structures for real estate, securities, or multi-business portfolios with state-specific advantages.",
            },
          ].map((persona, i) => (
        ...
        <FadeUp>
          <div className="mx-auto max-w-2xl text-center">
            <p className="text-lg leading-relaxed text-[var(--color-text-secondary)]">
              After formation, stay on top of annual filings, registered agent
              renewals, and state compliance deadlines.
            </p>
            <Link
              href="/compliance"
      ...
      <CTABand
        ...
        description="LLCs and corporations in Wyoming and Nevada with privacy-first formation packages."
