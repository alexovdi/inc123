...
| Column          | Links                                                                                                                                                                                       | Notes                                                                                                                              |
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| **Clusters**    | Anonymous LLC Formation · Nominee Services · Wyoming Private Incorporation · Nevada Private Incorporation · California Private LLC · Florida Private LLC · Offshore Privacy · BOI Reporting | 8 links. Lead with Anonymous LLC (highest search volume: 720–1,100/mo). BOI Reporting at bottom (emerging topic, lower priority).  |
...
- **Packages appear first** in the mobile menu (above pillar accordions) — mobile visitors who know what they want shouldn't have to scroll through educational nav
...
- **Desktop:** Full-width split — left: headline + subheadline + CTAs + trust strip; right: professional visual (Reno office photography or abstract shield/privacy imagery)
...
| **Trust Strip**             | "25 Years · Real Reno Office · All-Inclusive Pricing · Money-Back Guarantee"                                                                                        | Horizontal badge row. Four items maximum (scanner-friendly). Each gets a small icon. Uses `--muted` text with subtle icon tinting.                                                                                                                                         |
...
| 4   | MapPin     | "Real Reno Office"             | "Professional offices in Reno, Nevada with real staff you can visit. Not a P.O. box operation."                                               | Most competitors are remote or PO box only. Having a physical office visitors can actually walk into is a significant trust signal — especially for privacy-conscious clients who need to trust you with sensitive structures. |
...
| Building    | "Real Reno Office"              | Physical presence trust                                   |
...
| Address       | Reno, Nevada office address (Kingsbury Executive Suites)                | Supports LocalBusiness schema        |
...
| **Canonical URL**    | `https://incorporate123.com/` (pending domain decision — `.co` vs `.com`)                                                                                                                  |
...
| Alt text            | All images have descriptive alt text. Hero image: describe the office/visual, not "hero image."                                                                                                    |
...
| --------------------------------------- | -------------------- | ------------------- | ------------------------------------------------------ |
| Domain decision (`.co` vs `.com`)       | Pending              | David               | Canonical URL, all internal links, redirect plan       |
...
| Professional office photography         | Needed               | David / BIT Studios | Hero visual, trust signals, about page                 |
| David's professional bio photo          | Needed               | David               | About page + potential homepage trust signal           |
