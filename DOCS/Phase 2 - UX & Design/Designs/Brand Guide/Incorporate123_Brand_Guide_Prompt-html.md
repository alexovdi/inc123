...
Create a comprehensive brand guide for **Incorporate123** as a polished, visually designed HTML artifact. This is a client-facing deliverable that the business owner (David) will review and approve. It should look like a real brand book — sections with visual examples, color swatches, type specimens, and do/don't comparisons — not a text document with bullet points.
