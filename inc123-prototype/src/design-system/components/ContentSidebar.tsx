...
function ContentSidebar({
  ...
  return (
    <aside
      className={cn(
        "sticky top-24 bg-surface rounded-card border border-border p-4 space-y-6",
        className
      )}
    >
        ...
        <div className="space-y-3">
          <div className="flex items-start justify-between gap-2">
            <h3 className="text-body-sm font-semibold text-foreground">
              {packageShortcut.name}
            </h3>
            {packageShortcut.badge && (
          ...
          <div className="flex items-baseline gap-1">
            <span className="text-heading-sm font-mono font-semibold text-foreground">
              {packageShortcut.price}
            </span>
            <span className="text-caption text-muted">
              /{packageShortcut.period}
            </span>
          </div>
          <Button
            variant="cta"
            ...
            asChild
          >
            <a href={packageShortcut.href}>Get Started</a>
          </Button>
        </div>
      )}
